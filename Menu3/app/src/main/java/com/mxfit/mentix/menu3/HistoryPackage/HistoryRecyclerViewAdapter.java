...
import com.mxfit.mentix.menu3.Beans.Run;
...
import com.mxfit.mentix.menu3.Utils.ShowMap;
...
class HistoryRecyclerViewAdapter extends RecyclerView.Adapter<HistoryRecyclerViewAdapter.ViewHolder> {
    static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(final View itemView) {
            ...
            label = (TextView) itemView.findViewById(R.id.text_date);
    ...
    public HistoryRecyclerViewAdapter(List<Run> Runs, DatabaseHelper db, HistoryFragment ins)
    {
        mRuns = Runs;
        myDb = db;
        HisFrag = ins;
