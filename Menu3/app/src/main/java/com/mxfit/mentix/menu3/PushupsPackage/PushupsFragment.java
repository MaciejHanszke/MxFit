...
public class PushupsFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        txtTrainingType = (TextView) view.findViewById(R.id.TrainingType);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2) {
            if(resultCode == RESULT_OK) {
                day = GlobalValues.pushupsDay;
                trainingLevel = GlobalValues.pushupsTraininglevel;
            }
        }
    ...
    public void CreatePushupsTable()
    {
        ...
        txtSum.setText(""+sum);
        txttotalSum.setText(""+pushupsDone);
        txtDay.setText(""+day);
        ...
        if(lastPushupDate!= null) {
            txtTrainDate.setText(lastPushupDate);
        }
    }
    ...
    public void fixDays()
    {
        showMaxDays = myDb.getHowManyPushupDays(trainingLevel);
        if(day>showMaxDays)
        {
            day = 1;
            if(trainingLevel < myDb.getPushupTrainingsInTrainingLevel())
                trainingLevel++;
        }
    }
}
